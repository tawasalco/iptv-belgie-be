...
export function t(key: string, lang: LanguageCode = 'nl'): string {
...
export function translateUI(key: string, lang: LanguageCode = 'nl', replacements?: Record<string, string>): string {
  const parts = key.split('.');
